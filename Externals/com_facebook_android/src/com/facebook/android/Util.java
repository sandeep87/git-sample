...
public final class Util {
	...
	/**
	 * Set this to true to enable log output. Remember to turn this back off before releasing. Sending sensitive data to log is a security risk.
	 */
	...
	public static String encodePostBody (Bundle parameters, String boundary) {
		...
		for (String key : parameters.keySet()) {
			/*
			 * if (parameters.getByteArray(key) != null) { continue; }
			 */
	...
	public static String openUrl (String url, String method, Bundle params) throws MalformedURLException, IOException {
		...
		if (!method.equals("GET")) {
			...
			for (String key : params.keySet()) {
				/*
				 * if (params.getByteArray(key) != null) { dataparams.putByteArray(key, params.getByteArray(key)); }
				 */
