...
public class ProgressSliderView
    ...
    public ProgressSliderView(CommandListener commandListener, String title) {
        ...
        final Gauge determinateGauge = new Gauge(
            Compatibility.toLowerCaseIfFT("Determinate progress indicator"),
            false,
            10,
            0);
        ...
        Gauge gauge = new Gauge(
            Compatibility.toLowerCaseIfFT("Indeterminate progress indicator"),
            false,
            Gauge.INDEFINITE,
        ...
        slider =
            new Gauge(Compatibility.toLowerCaseIfFT("Slider"), true, 100, 0);
        this.append(slider);
    }

    protected boolean confirmChanges() {
        return sliderPosition != slider.getValue();
    }
