...
public class ImplicitActionListView extends CustomList implements CommandListener {
    
    private final int MAX_ITEMS = 10;
    private CommandListener parentCommandListener;
    private BackStack backStack;
    
    public ImplicitActionListView(MIDlet parent, CommandListener commandListener) {
        super(Compatibility.toLowerCaseIfFT("Implicit + action"), List.IMPLICIT);
        ...
        this.addCommand(Commands.ADD_ICON);
    ...
    public void commandAction(Command c, Displayable d) {
        ...
        else if (c == Commands.ADD_ICON) {
            this.scrollToElement(this.append(
                Compatibility.toLowerCaseIfFT("List item ")
                + String.valueOf(this.size() + 1), null));
        }
        else {
            parentCommandListener.commandAction(c, d);
        }
