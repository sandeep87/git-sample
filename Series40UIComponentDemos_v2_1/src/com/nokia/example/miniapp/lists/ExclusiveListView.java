...
public class ExclusiveListView extends CustomList implements CommandListener {
    
    private static final String RMS_NAME = "ExclusiveListExample";
    private final int MAX_ITEMS = 10;
    private int exclusiveSelection;
    private CommandListener parentCommandListener;
    private BackStack backStack;
    
    public ExclusiveListView(MIDlet parent, CommandListener commandListener) {
