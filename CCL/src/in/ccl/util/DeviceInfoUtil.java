...
public class DeviceInfoUtil {
	...
	Context mContext;
	String versionName, packageName, filePath, phoneModel, androidVersion,
			board, brand, device, display, fingerPrint, host, id, model,
			product, tags, time, type, user, totalInternalMemory,
			availableInternalMemory, screenResolution;
	...
	public ArrayList<String> collectDeviceInfo() {
		...
		try {
			...
			availableInternalMemory = "availableInternalMemory : "
			...
			if (mContext != null && mContext instanceof Activity) {
				...
				((Activity) mContext).getWindowManager().getDefaultDisplay()
						.getMetrics(dm);
				screenResolution = "screenResolution : " + dm.widthPixels
						+ " x " + dm.heightPixels;
			}
	 ...
	 * 
	 * @return <code>true</code> if external media is available and have some
	 *         free memory to write, else <code>flase</code>
	 */
