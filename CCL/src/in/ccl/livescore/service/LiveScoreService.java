					...
					if (compareKey.equals("match_schedule")) {
						...
						if (matchSchedule != null && matchSchedule.getStartTime() != null && matchSchedule.getEndDate() != null && matchSchedule.getStatus() != null) {
							...
							try {
								...
								if (questionDateStr.equals(todayStr) && date.getTime() >= matchSchedule.getStartTime().getTime() && date.getTime() <= matchSchedule.getEndDate().getTime() && matchSchedule.getStatus().equalsIgnoreCase("started") && matchSchedule.getEndDate().compareTo(todayDate) > 0) {
