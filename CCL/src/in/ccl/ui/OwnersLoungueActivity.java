...
import in.ccl.helper.TextViewJustify;
...
//		TextViewJustify.getInstance().justifyText(mOwnerOneDataMumbai, 175f); 
		...
		/*//mOwnerOneDataMumbai.setText(Html.fromHtml(getString(R.string.owner_one_data_mumbai)));
		TextViewJustify.justifyText(((TextView)findViewById(R.id.owner_one_data_mumbai)), 175f); */
