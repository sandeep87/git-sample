...
/**
 * This class extends the standard Android ImageView View class with some features that are useful for downloading, decoding, and displaying Picasa images.
 * 
 */
public class PhotoView extends ImageView {
	...
	/*
	 * This callback is invoked when the ImageView is removed from a Window. It "unsets" variables to prevent memory leaks.
	 */
	@Override
	...
	protected boolean setFrame (int frameLeft, int frameTop, int frameRight, int frameBottom) {
		...
		int drawableWidth = 50;
		int drawableHeight = 50;
		if (getDrawable() != null) {
